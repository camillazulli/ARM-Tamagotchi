...
void TouchPanel_Calibrate(void)
{
  ...
  {     
   //#ifndef SIMULATOR
	 DelayUS(1000 * 500); //delay which permits to touch the display in terms of time -> when we use the Landtiger
	//	DelayUS(1000); //when we use the simulator the time is greater
	 //#endif	
