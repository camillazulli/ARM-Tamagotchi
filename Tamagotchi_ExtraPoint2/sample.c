...
extern int hours, minutes, seconds, sec_count;
extern char age[50];
...
int main(void)
 {
  ...
  GUI_Text(160, 294, "Snack", Blue, White);	
	...
	//the age and the animation is handled by TIMER 0, refresh rate of 1 sec. TIMER 0 also manage the flow of Lovelitchi's life
	//decrementing batteries, every 5 sec
